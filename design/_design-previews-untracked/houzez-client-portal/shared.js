...
(function () {
  ...
  var I18N = {
    en: {
      ...
      cpdsTit: 'Compound Intelligence Map', cpdsSub: 'New Cairo · Live — 29 compounds benchmarked by AI score, growth and price.',
      ...
      mapHint: 'Tap a marker — compound intel appears here', beds: 'Beds', baths: 'Baths', avg: 'Avg. villa', growth: 'YoY growth', aiScore: 'AI Score', rentAvg: 'Rent avg.',
      ...
      eyeZone: 'Explore zones', zoneTit: 'Neighborhoods of New Cairo', zoneSub: 'Four distinct districts, one curated market.', cpdsWord: 'compounds',
    ...
    ar: {
      ...
      cpdsTit: 'خريطة الذكاء العقاري', cpdsSub: 'القاهرة الجديدة · مباشر — 29 كمبوند مقيّمة بالذكاء الاصطناعي والنمو والسعر.',
      ...
      mapHint: 'اضغط على علامة — تظهر بيانات الكمبوند هنا', beds: 'غرف', baths: 'حمامات', avg: 'متوسط الفيلا', growth: 'نمو سنوي', aiScore: 'تقييم الذكاء', rentAvg: 'متوسط الإيجار',
      ...
      eyeZone: 'استكشف المناطق', zoneTit: 'أحياء القاهرة الجديدة', zoneSub: 'أربع مناطق مميزة، سوق واحد منتقى.', cpdsWord: 'كمبوند',
